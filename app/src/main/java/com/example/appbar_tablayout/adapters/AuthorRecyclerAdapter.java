package com.example.appbar_tablayout.adapters;
...
public class AuthorRecyclerAdapter extends RecyclerView.Adapter<AuthorRecyclerAdapter.AuthorViewHolder> {
    ...
    public void onBindViewHolder(AuthorViewHolder holder, int position) {
        AuthorInfo authorInfo = authorInfoList.get(position);
...
//                Collections.swap(authorInfoList, index, index + 1);
//            }
//        } else {
//            for (int index = fromPosition; index > toPosition; index--) {
//                Collections.swap(authorInfoList, index, index - 1);
...
//        authorInfoList.remove(position);//删除数据
